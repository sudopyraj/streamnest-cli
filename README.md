...
[**Download the Android APK**](https://github.com/sudopyraj/streamnest-cli/releases/download/v1.0.1-android/app-standalone-debug.apk)
 · [View the release](https://github.com/sudopyraj/streamnest-cli/releases/tag/v1.0.1-android)
...
[latest StreamNest Android release](https://github.com/sudopyraj/streamnest-cli/releases/tag/v1.0.1-android).
